--Made by FiroxNotBanned and rofzu
for i,v in next, game:GetService("Players").LocalPlayer.Character:GetDescendants() do
if v:IsA("Accessory") then 
game:GetService("RunService").Heartbeat:connect(function()
v.Handle.Velocity = Vector3.new(0,29.99,0)
end)
end
end

local v = game:GetService("Players").LocalPlayer.Character["Right Arm"]
game:GetService("RunService").Heartbeat:connect(function()
v.Velocity = Vector3.new(0,29.99,0)
end)

local v = game:GetService("Players").LocalPlayer.Character["Left Arm"]
game:GetService("RunService").Heartbeat:connect(function()
v.Velocity = Vector3.new(0,29.99,0)
end)

local v = game:GetService("Players").LocalPlayer.Character["Right Leg"]
game:GetService("RunService").Heartbeat:connect(function()
v.Velocity = Vector3.new(0,29.99,0)
end)

local v = game:GetService("Players").LocalPlayer.Character["Left Leg"]
game:GetService("RunService").Heartbeat:connect(function()
v.Velocity = Vector3.new(0,29.99,0)
end)
-- -gh 4932541287,4855847190
game:GetService("Players").LocalPlayer.Character["Evil Aura"].Name = "evil"
game:GetService("Players").LocalPlayer.Character["Northern Star"].Name = "northern"
game:GetService("Players").LocalPlayer.Character["swordhalo"].Name = "first"
...
local script = game:GetObjects("rbxassetid://7266438741")[1]
...
modet.Text = "???:" ---dont change this name pls is make me sad is Rofzu_Exiled edit :c---
...
local function align(part0, part1)
    ...
    align(hat.Handle, rotzo)
        local hat = game:GetService("Players").LocalPlayer.Character["2"] --red sword outer
...
local function align(part0, part1)
    ...
    align(hat.Handle, rotzo)
        local hat = game:GetService("Players").LocalPlayer.Character["3"] --red sword outer
...
local function align(part0, part1)
        ...
        local attachment0 = Instance.new("Attachment", part0)
        attachment0.Position = Vector3.new(-1, -1, -0) --Custom Positioning Values Here
        attachment0.Orientation = Vector3.new(-0, -0, -225) --Custom Rotationing Values here
        local attachment1 = Instance.new("Attachment", part1)
        local weldpos = Instance.new("AlignPosition", part0)
        weldpos.Attachment0 = attachment0
        weldpos.Attachment1 = attachment1
    ...
    align(hat.Handle, rotzo)
        local hat = game:GetService("Players").LocalPlayer.Character["4"] --red sword outer
...
local function align(part0, part1)
        ...
        local attachment0 = Instance.new("Attachment", part0)
        attachment0.Position = Vector3.new(-1, -1, -0) --Custom Positioning Values Here
        attachment0.Orientation = Vector3.new(-0, -0, -315) --Custom Rotationing Values here
        local attachment1 = Instance.new("Attachment", part1)
        local weldpos = Instance.new("AlignPosition", part0)
        weldpos.Attachment0 = attachment0
        weldpos.Attachment1 = attachment1
    ...
    align(hat.Handle, rotzo)
local hat = game:GetService("Players").LocalPlayer.Character["first"] --red sword outer
local function align(part0, part1)
...
align(hat.Handle, rotzo2)
            local hat = game:GetService("Players").LocalPlayer.Character["1A"] --red sword outer
...
local function align(part0, part1)
        ...
        local attachment0 = Instance.new("Attachment", part0)
        attachment0.Position = Vector3.new(-1, -1, -0) --Custom Positioning Values Here
        attachment0.Orientation = Vector3.new(-0, -0, -180) --Custom Rotationing Values here
        local attachment1 = Instance.new("Attachment", part1)
        local weldpos = Instance.new("AlignPosition", part0)
        weldpos.Attachment0 = attachment0
        weldpos.Attachment1 = attachment1
    ...
    align(hat.Handle, rotzo)
            local hat = game:GetService("Players").LocalPlayer.Character["2A"] --red sword outer
...
local function align(part0, part1)
    ...
    align(hat.Handle, rotzo)
local hat = game:GetService("Players").LocalPlayer.Character["evil"] --red sword outer
local function align(part0, part1)

        part0.AccessoryWeld:Destroy()
        local attachment0 = Instance.new("Attachment", part0)
        attachment0.Position = Vector3.new(3, -0, -0) --Custom Positioning Values Here
        attachment0.Orientation = Vector3.new(-0, -0, 45) --Custom Rotationing Values here
        local attachment1 = Instance.new("Attachment", part1)
        local weldpos = Instance.new("AlignPosition", part0)
        weldpos.Attachment0 = attachment0
...
align(hat.Handle, rotzo)
local hat = game:GetService("Players").LocalPlayer.Character["northern"] --red sword outer
local function align(part0, part1)
...
wait(0.2)
local bc1 = workspace:WaitForChild("Rofzu_Exiled")["Body Colors"]:Clone()
bc1.Parent = obj1
local bc2 = workspace:WaitForChild("Rofzu_Exiled")["Body Colors"]:Clone()
bc2.Parent = Model0
shirt = Instance.new("Shirt", obj1)
shirt.Name = "Shirt"
pants = Instance.new("Pants", obj1)
pants.Name = "Pants"
obj1.Shirt.ShirtTemplate = workspace:WaitForChild("Rofzu_Exiled").Shirt.ShirtTemplate
obj1.Pants.PantsTemplate = workspace:WaitForChild("Rofzu_Exiled").Pants.PantsTemplate
shirt1 = Instance.new("Shirt", Model0)
shirt1.Name = "Shirt1"
pants1 = Instance.new("Pants", Model0)
pants1.Name = "Pants1"
Model0.Shirt1.ShirtTemplate = workspace:WaitForChild("Rofzu_Exiled").Shirt.ShirtTemplate
Model0.Pants1.PantsTemplate = workspace:WaitForChild("Rofzu_Exiled").Pants.PantsTemplate
local mesh1 = workspace:WaitForChild("Rofzu_Exiled").Head.Mesh:Clone()
mesh1.Parent = obj6
local mesh2 = workspace:WaitForChild("Rofzu_Exiled").Head.Mesh:Clone()
mesh2.Parent = Part5
local faz1 = workspace:WaitForChild("Rofzu_Exiled").Head.face:Clone()
faz1.Parent = obj6
local faz2 = workspace:WaitForChild("Rofzu_Exiled").Head.face:Clone()
faz2.Parent = Part5
end
--]]
...
for i,v in pairs(Model0:GetChildren())do
	...
	obj5.CFrame = workspace:WaitForChild("Rofzu_Exiled").Torso.CFrame + Vector3.new(5,0,0)
	obj6.CFrame = workspace:WaitForChild("Rofzu_Exiled").Head.CFrame + Vector3.new(5,0,0)
	obj7.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Left Arm"].CFrame + Vector3.new(5,0,0)
	obj2.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Right Arm"].CFrame + Vector3.new(5,0,0)
	obj3.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Left Leg"].CFrame + Vector3.new(5,0,0)
	obj4.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Right Leg"].CFrame + Vector3.new(5,0,0)
	Part4.CFrame = workspace:WaitForChild("Rofzu_Exiled").Torso.CFrame + Vector3.new(-5,0,0)
	Part5.CFrame = workspace:WaitForChild("Rofzu_Exiled").Head.CFrame + Vector3.new(-5,0,0)
	Part6.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Left Arm"].CFrame + Vector3.new(-5,0,0)
	Part1.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Right Arm"].CFrame + Vector3.new(-5,0,0)
	Part2.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Left Leg"].CFrame + Vector3.new(-5,0,0)
	Part3.CFrame = workspace:WaitForChild("Rofzu_Exiled")["Right Leg"].CFrame + Vector3.new(-5,0,0)
end
end))
--]]
...
if k == "5" and attack == false and ModeOfGlitch ~= Rofzu_Exiled then
ModeOfGlitch = Rofzu_Exiled
storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = true
chaosmode = false
...
chaosmode = false
Shadow = true
RecolorTextAndRename("Putin x Trump x Kim Yan Un",Color3.new(0,1,0),Color3.new(0.8,1,0.5),"Bodoni")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
newTheme("rbxassetid://304319566",0,1.01,10)
...
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
newTheme("rbxassetid://169736440",0,1.01,10)
...
chaosmode = false
Shadow = true
RecolorTextAndRename("Fatass Homer",Color3.new(0,0,0),Color3.new(0,0,0),"Arcade")
...
chaosmode = false
Shadow = false
RecolorTextAndRename("^_^",Color3.new(255,255,255),Color3.new(0,0,0),"Arcade")
...
chaosmode = false
Shadow = false
RecolorTextAndRename("Ｃ ｈ ｉ ｌ ｌ",Color3.new(255,255,255),Color3.new(0,0,0),"Arcade")
newTheme("rbxassetid://4452703676",0,1,10)
...
chaosmode = false
Shadow = true
RecolorTextAndRename("Egirl Lover",Color3.new(0,0,0),BrickColor.new("Lily white").Color,"Bodoni")
newTheme("rbxassetid://6087386152",0,1,7)
MAINRUINCOLOR = BrickColor.new("Really black")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
end
...
chaosmode = false
Shadow = true
RecolorTextAndRename("IMPOSTOR",BrickColor.new("Crimson").Color,BrickColor.new("Really red").Color,"Antique")
newTheme("rbxassetid://6132224076",0,1,7)
...
chaosmode = false
Shadow = false
RecolorTextAndRename("IMPOSTER X",BrickColor.new("Really red").Color,BrickColor.new("Crimson").Color,"Antique")
kan.TimePosition = 0
newTheme("rbxassetid://6132224076",0,1,8)
MAINRUINCOLOR = BrickColor.new("Really red")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
end
...
chaosmode = false
Shadow = true
RecolorTextAndRename("CORRUPTION OF UR FILES",Color3.new(106,0,255),BrickColor.new("Really black").Color,"Arcade")
newTheme("rbxassetid://731628914",58.15,0.98,1)
...
kan.TimePosition = 0
newTheme("rbxassetid://181344739",0,0.7,8)
...
chaosmode = false
Shadow = true
RecolorTextAndRename("BrOKen Baka",Color3.new(0,0,0),BrickColor.new("Really black").Color,"SciFi")
newTheme("rbxassetid://181344739",0,1.01,2)
MAINRUINCOLOR = BrickColor.new("Really black")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
end
if k == "t" and attack == false and ModeOfGlitch ~= 14 then
...
chaosmode = false
Shadow = true
RecolorTextAndRename("EDGY KIDNAPPER",Color3.new(106,0,255),BrickColor.new("Really black").Color,"Arcade")
newTheme("rbxassetid://5703095377",0,1,7)
MAINRUINCOLOR = BrickColor.new("Royal purple")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true)
end
...
chaosmode = false
Shadow = false
RecolorTextAndRename("Dr. Heinz Doofenshmirtz",Color3.new(1,1,0),Color3.new(0,0,0),"Bodoni")
kan.TimePosition = 0
...
chaosmode = false
Shadow = false
RecolorTextAndRename("WhiteCop",Color3.new(0,0,0),Color3.new(0,1,0),"Bodoni")
kan.TimePosition = 0
...
chaosmode = false
Shadow = false
RecolorTextAndRename("BlackCop",Color3.new(0,0,0),Color3.new(1,0,0),"Bodoni")
kan.TimePosition = 0
...
chaosmode = false
Shadow = false
RecolorTextAndRename("JESUS PEACE",Color3.new(76,217,255),Color3.new(0,0,0),"Arcade")
kan.TimePosition = 0
newTheme("rbxassetid://5406448658",0,1,8)
...
if ModeOfGlitch == Rofzu_Exiled then
...
if ModeOfGlitch ~= 1264532489 and ModeOfGlitch ~= 8376532578634534 and ModeOfGlitch ~= Rofzu_Exiled and ModeOfGlitch ~= 55469696922 and ModeOfGlitch ~= 4367677813 and ModeOfGlitch ~= 9999999921111 and ModeOfGlitch ~= 999999999556 then
imgca.ImageTransparency = 1
elseif ModeOfGlitch == Rofzu_Exiled or ModeOfGlitch == 8376532578634534 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 999999999556 then
...
elseif ModeOfGlitch == Rofzu_Exiled then
